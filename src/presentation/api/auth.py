...
# POST /auth/register
register_router = fastapi_users.get_register_router(UserRead, UserCreate)  # type: ignore

# Users router: CRUD operations on users
# GET/PUT/PATCH/DELETE /users/{id}
users_router = fastapi_users.get_users_router(UserRead, UserUpdate)  # type: ignore
